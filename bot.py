                 ...
                 if msg.from_ in admin:
                    ...
                    for target in targets:
                        try:
                            ...
                            ki2.sendText(msg.to,"成功")
                        except Exception as e:
                            ki2.sendText(msg.to,"失敗")
                            print "Clone Execute"
                 ...
                 if msg.from_ in admin:
                    ...
                    for target in targets:
                        try:
                            ...
                            ki3.sendText(msg.to,"成功")
                        except Exception as e:
                            ki3.sendText(msg.to,"失敗")
                            print "Clone Execute"
                 ...
                 if msg.from_ in admin:
                    ...
                    for target in targets:
                        try:
                            ...
                            ki4.sendText(msg.to,"成功")
                        except Exception as e:
                            ki4.sendText(msg.to,"失敗")
                            print "Clone Execute"
                 ...
                 if msg.from_ in admin:
                    ...
                    for target in targets:
                        try:
                            ...
                            ki5.sendText(msg.to,"成功")
                        except Exception as e:
                            ki5.sendText(msg.to,"失敗")
                            print "Clone Execute"
                 ...
                 if msg.from_ in admin:
                    ...
                    for target in targets:
                        try:
                            ...
                            ki6.sendText(msg.to,"成功")
                        except Exception as e:
                            ki6.sendText(msg.to,"失敗")
                            print "Clone Execute"
                 ...
                 if msg.from_ in admin:
                    ...
                    for target in targets:
                        try:
                            ...
                            ki7.sendText(msg.to,"成功")
                        except Exception as e:
                            ki7.sendText(msg.to,"失敗")
                            print "Clone Execute"
                 ...
                 if msg.from_ in admin:
                    ...
                    for target in targets:
                        try:
                            ...
                            ki8.sendText(msg.to,"成功")
                        except Exception as e:
                            ki8.sendText(msg.to,"失敗")
                            print "Clone Execute"
                 ...
                 if msg.from_ in admin:
                    ...
                    for target in targets:
                        try:
                            ...
                            ki9.sendText(msg.to,"成功")
                        except Exception as e:
                            ki9.sendText(msg.to,"失敗")
                            print "Clone Execute"
            	...
            	if msg.from_ in admin:
            		...
            		if cmd == "on":
            			if mimic["status"] == False:
            				mimic["status"] = True
            				cl.sendText(msg.to,"Mimic開啟")
            			else:
            				cl.sendText(msg.to,"Mimic已開啟")
            		elif cmd == "off":
            			if mimic["status"] == True:
            				mimic["status"] = False
            				cl.sendText(msg.to,"Mimic關閉")
            			else:
            				cl.sendText(msg.to,"Mimic已關閉")
            		elif "add:" in cmd:
